...
import '/index.dart';
import 'reg_endurance_widget.dart' show RegEnduranceWidget;
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class RegEnduranceModel extends FlutterFlowModel<RegEnduranceWidget> {
  ///  Local state fields for this page.

  bool regFieldsValid = false;
  ...
  String? _textController9Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Emer Contact is required';
    }
  ...
  /// Action blocks.
  Future validateSubEvent(BuildContext context) async {}
}
