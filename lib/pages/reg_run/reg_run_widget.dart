                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                    ...
                                    if ((_model.dropDownValue2 == null ||
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          ...
                                          backgroundColor: Color(0xFFB139D2),
                                        ),
                                      );
                                      return;
                                    }
                                  ...
                                  if (_model.dropDownValue1 == null) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        ...
                                        duration: Duration(milliseconds: 4000),
                                        backgroundColor: Color(0xFFD1100A),
                                      ),
                                    );
                                    return;
                                  }
                                  if (_model.dropDownValue2 == null) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        ...
                                        duration: Duration(milliseconds: 4000),
                                        backgroundColor: Color(0xFFC52D04),
                                      ),
                                    );
                                    return;
                                  }
                                  ...
                                  FFAppState().isAdult = functions
                                      .checkIfAdult(FFAppState().ageStr);
                                  safeSetState(() {});
