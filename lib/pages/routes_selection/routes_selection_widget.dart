...
import 'routes_selection_model.dart';
export 'routes_selection_model.dart';
...
class RoutesSelectionWidget extends StatefulWidget {
  ...
  static String routeName = 'RoutesSelection';
  static String routePath = '/routesSelection';
...
class _RoutesSelectionWidgetState extends State<RoutesSelectionWidget> {
  late RoutesSelectionModel _model;
