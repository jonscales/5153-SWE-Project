...
import 'reg_m_t_b_model.dart';
export 'reg_m_t_b_model.dart';

class RegMTBWidget extends StatefulWidget {
  const RegMTBWidget({
    super.key,
  ...
  static String routeName = 'RegMTB';
  static String routePath = '/regMTB';

  @override
  State<RegMTBWidget> createState() => _RegMTBWidgetState();
}

class _RegMTBWidgetState extends State<RegMTBWidget> {
  late RegMTBModel _model;
                                  ...
                                  if (_model.dropDownValue1 == null) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        ...
                                        duration: Duration(milliseconds: 4000),
                                        backgroundColor: Color(0xFFE43203),
                                      ),
                                    );
                                    return;
                                  }
                                  if (_model.dropDownValue2 == null) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        ...
                                        duration: Duration(milliseconds: 4000),
                                        backgroundColor: Color(0xFFDA2807),
                                      ),
                                    );
                                    return;
                                  }
